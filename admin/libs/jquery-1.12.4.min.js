...
//设置全局ajax默认选项：菜鸟教程网站介绍（比较详细）:https://www.runoob.com/jquery/ajax-ajaxsetup.html
//ajaxSetup({}):设置全局默认选项
//beforeSend(){}发送ajax请求前 先执行这里面的代码
$.ajaxSetup({
  beforeSend(xhr) {
    //在发送ajax请求给服务器前先设置请求头  把本地的token设置在请求头的这个键上Authorization
